    ...
    >
      ...
      >
        ...
        <a
          href="#contact"
          data-cursor-hover
          className="px-7 py-3 font-mono text-sm tracking-wide text-cyan border border-cyan/40 rounded-sm hover:bg-cyan/10 transition-colors hover:-translate-y-0.5 duration-200"
        >
          Get in Touch
        </a>
      </motion.div>
